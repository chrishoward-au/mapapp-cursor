...
### Fixed
- Resolved PostCSS integration issue with Tailwind CSS v4
- Updated configuration to use @tailwindcss/postcss package 
- Fixed dark mode implementation compatibility issues

## [0.3.1] - 2024-03-22

### Added
- Dark mode support with automatic system preference detection
- Theme toggle button for manual dark/light mode switching
- Dark mode map style using Mapbox Dark theme
- Persistent theme preference using localStorage
- Consistent dark mode styling across all UI components
